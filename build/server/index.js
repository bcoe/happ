...
function HabitListItem(props) {
  ...
  return hideRow() ? "" : /* @__PURE__ */ jsx("div", { ref: setNodeRef, style, ...attributes, "data-sentry-component": "HabitListItem", "data-sentry-source-file": "habit-list-item.tsx", children: /* @__PURE__ */ jsxs("div", { className: "flex w-full bg-white text-gray-800 py-2 px-4 border border-gray-400 rounded shadow habit-item disable-touch", children: [
