    ...
    <div className={'grid grid-cols-2'}>
      ...
      <div className={'mt-10'}>
        <blockquote class="text-xl italic font-semibold text-gray-900 dark:text-white">
            ...
            <p>HabitTrack.me lets you track daily habits that you'd like to make a part of your routine. Its metrics allow you to see if you're meeting your goals week over week.</p>
        </blockquote>
      </div>
    </div>
  )
